<%@ Page Title="" Language="C#" MasterPageFile="~/Companies/CompanyMaster.Master" AutoEventWireup="true" CodeBehind="RiskHistory.aspx.cs" Inherits="RiskManagementSystem.Companies.RiskHistory" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="توضیحات">
                        <ItemTemplate>
                            ...
                            <a href='<%# Eval("StageId","/Companies/RiskDetailHistory.aspx?stageID={0}") %>'>جزییات</a>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:TemplateField>
                </Columns>
