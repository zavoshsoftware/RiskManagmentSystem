<%@ Page Title="" Language="C#" MasterPageFile="~/Companies/CompanyMaster.Master" AutoEventWireup="true" CodeBehind="DlFiles.aspx.cs" Inherits="RiskManagementSystem.Companies.DlFiles" %>
...
<div class="minheight">
        ...
        <div class="ContentDiv">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input id="Button2" type="button" class="btn btn-success" value="جست و جو" onclick="$('#SearchDiv').css('display','block');" />
                    <br />
                    <div id="SearchDiv">
