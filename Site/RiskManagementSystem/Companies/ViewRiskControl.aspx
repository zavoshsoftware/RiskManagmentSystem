<%@ Page Title="" Language="C#" MasterPageFile="~/Companies/CompanyMaster.Master" AutoEventWireup="true" CodeBehind="ViewRiskControl.aspx.cs" Inherits="RiskManagementSystem.Companies.ViewRiskControl" %>
        ...
        <div class="ContentDiv">
            <asp:MultiView ID="mvControl" runat="server" ActiveViewIndex="0">
                <asp:View ID="vwList" runat="server">
                    ...
                    <asp:Button ID="btnReturn" runat="server" OnClick="btnReturn_Click" Text="بازگشت" CssClass="btn btn-warning" />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input id="Button2" type="button" value="جست و جو" onclick="$('#SearchDiv').css('display','block');" class="btn btn-success" />
                    <br />
                    <div id="SearchDiv">
...
"
                            ...
                            &nbsp;
                            <asp:Button ID="btnSearch" runat="server" Text="بگرد" OnClick="btnSearch_Click" CssClass="btn btn-success" />
                            &nbsp;
                            <input id="Button4" type="button" value="انصراف" onclick="$('#SearchDiv').css('display','none');" class="btn btn-danger" />
                            <br />
