<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="UploadFiles.aspx.cs" Inherits="RiskManagementSystem.Admin.UploadFiles" %>
                ...
                <asp:View ID="vwList" runat="server">
                    ...
                    <div id="SearchDiv">
                        <asp:Panel ID="Panel1" runat="server" GroupingText="جست و جو بر اساس نام "
                            ...
                            &nbsp;
                            <asp:Button ID="btnSearch" CssClass="btn btn-success" runat="server" Text="بگرد" OnClick="btnSearch_Click" />
                            &nbsp;
