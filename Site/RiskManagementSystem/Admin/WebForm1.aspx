<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="RiskManagementSystem.Admin.WebForm1" %>
            ...
            <asp:MultiView ID="mvRisk" runat="server" ActiveViewIndex="0">
                ...
                <asp:View ID="vwEdit" runat="server">
                    ...
                    <div id="butonDiv">
                        ...
                        <asp:CheckBox ID="chkNotNormal" runat="server" Text="غیر عادی" />
                    </div>
                    <br />
                 <table class="style1">
                    <tr>
