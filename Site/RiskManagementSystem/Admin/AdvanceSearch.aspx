<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdvanceSearch.aspx.cs" Inherits="RiskManagementSystem.Admin.AdvanceSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="minheight">
        <table class="style1">
            <tr>
                <td>کلمه مورد جست و جو:</td>
                <td>
                    <asp:TextBox ID="txtSearch" runat="server" Width="400px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>محل مورد جست و جو</td>
                <td>
                    <asp:DropDownList ID="ddlSearchType" runat="server" Width="400px">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnDearch" runat="server" OnClick="btnDearch_Click"
                        Text="جست و جو" CssClass="btn btn-primary" />
                    &nbsp;&nbsp;&nbsp;
