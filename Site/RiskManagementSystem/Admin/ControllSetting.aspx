<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ControllSetting.aspx.cs" Inherits="RiskManagementSystem.Admin.ControllSetting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-heading">مدیریت اقدامات کنترلی</div>
        ...
        <div class="titleDiv">
            ...
            <div class="fieldGroup">
             ...
             <div class="fieldGroup">
                  ...
                  برای مشاهده مقررات و دستورالعمل های <a href="UploadFiles.aspx">اینجا</a> را کلیک کنید
...
"
                            ...
                            &nbsp;
                            <input id="Button4" type="button" class="btn btn-danger" value="انصراف" onclick="$('#SearchDiv').css('display','none');" />
                            <br />
                ...
                <asp:View ID="vwEdit" runat="server">
                    ...
                    <div class="fieldGroup">
                        <div class="right2">
                           اقدام پیشنهادی کنترلی :</div>
                        &nbsp;<div class="left">
                            <asp:TextBox ID="txtControl" runat="server" Width="500px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvTitle" runat="server" ErrorMessage="  اقدام پیشنهادی کنترلی -  پیشگیرانه را وارد نمایید"
                                ForeColor="Red" ControlToValidate="txtControl" Display="Dynamic">→</asp:RequiredFieldValidator>
                        </div>
                    </div>
