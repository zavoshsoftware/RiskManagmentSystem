<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="OperationSetting.aspx.cs" Inherits="RiskManagementSystem.Admin.OperationSetting" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-primary">
        <div class="panel-heading">مدیریت عملیات ها</div>
        <div class="panel-body">
            ...
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="بازگشت" CssClass="btn btn-warning" />
                    ...
                    <asp:View ID="vwDelete" runat="server">
                        ...
                        &quot; هستید؟&nbsp;
            <asp:Button ID="btnYes" runat="server" CssClass="btn btn-success" OnClick="btnYes_Click" Text="بلی"
                Width="50px" />
                        &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnNo" runat="server" OnClick="btnNo_Click" Text="خیر" CssClass="btn btn-danger"
                Width="50px" />
                    </asp:View>
