<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="UserSetting.aspx.cs" Inherits="RiskManagementSystem.Admin.UserSetting" %>
  ...
  <div class="minheight">
   <asp:MultiView ID="mvUsers" runat="server" ActiveViewIndex="0">
        <asp:View ID="vwList" runat="server">
            ...
            <asp:Button ID="btnUsers" runat="server" Text="اضافه کردن کاربر جدید" 
          ...
          <asp:View ID="vwEdit" runat="server">
                    ...
                    <div class="right">
                           نقش کاربر:</div>
                    &nbsp;<div class="left">
                    <asp:DropDownList ID="ddlRoles" runat="server" DataSourceID="edsRoles" 
                            DataTextField="RoleTitle" DataValueField="RoleID" Width="130px">
                        </asp:DropDownList>
