...
namespace RiskManagementSystem.Admin
{
    public partial class UploadFiles : System.Web.UI.Page
    {
        ...
        public void GrdFilesDataSource()
        {
            ...
            var n = from fg in DataContext.Context.FileGroups
                ...
                case "DoDelete":
                    {
                        ...
                        var n = (from p in DataContext.Context.FileGroups
                ...
                case "DLCH":
                    {
                        ...
                        var m = (from p in DataContext.Context.Files
                                 where p.FileGroupID == FileGroupID
                                 select p).FirstOrDefault();
        ...
        private void Delete()
        {
            ...
            (from p in DataContext.Context.FileGroups
             where p.FileGroupID == FileGroupID
        ...
        private void LoadForm()
        {
            ...
            var m = (from fg in DataContext.Context.FileGroups
                     where fg.FileGroupID == FileGroupID
                     select fg).FirstOrDefault();

            var n = (from p in DataContext.Context.Files
        ...
        private void InsertForm()
        {
            ...
            DataContext.Context.FileGroups.AddObject(fg);
            DataContext.Context.SaveChanges();
            Files p = new Files()
            {
            ...
            DataContext.Context.Files.AddObject(p);
            DataContext.Context.SaveChanges();
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                var n = (from a in DataContext.Context.FileGroups
