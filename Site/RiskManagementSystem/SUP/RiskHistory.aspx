<%@ Page Title="" Language="C#" MasterPageFile="~/SUP/SupervisorMaster.Master" AutoEventWireup="true" CodeBehind="RiskHistory.aspx.cs" Inherits="RiskManagementSystem.SUP.RiskHistory" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="توضیحات">
                        <ItemTemplate>
                            ...
                            <a href='<%# String.Format("/sup/RiskDetailHistory.aspx?stageID={0}&companyId={1}&type={2}", Eval("StageId"), Eval("CompanyUserID"),Eval("type")) %>'>
