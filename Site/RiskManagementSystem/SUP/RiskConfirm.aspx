<%@ Page Title="" Language="C#" MasterPageFile="~/SUP/SupervisorMaster.Master" AutoEventWireup="true" CodeBehind="RiskConfirm.aspx.cs" Inherits="RiskManagementSystem.SUP.RiskConfirm" %>
    ...
    <div class="minheight">
        ...
        <asp:MultiView ID="mvRisk" runat="server" ActiveViewIndex="0">
            <asp:View ID="vwCompany" runat="server">
                <center>
                    <b>لیست پیمانکار هایی که اقدام به وارد کردن شدت ریسک نموده اند.</b></center>
                <br />
                <asp:GridView ID="grdCompany" runat="server" CellPadding="4" ForeColor="#333333"
                    ...
                    <Columns>
                        <asp:BoundField DataField="Name" HeaderText="نام پیمانکار">
            ...
            <asp:View ID="vwRiskView" runat="server">
                ...
                <asp:GridView ID="grdRisk" runat="server" Width="100%" AutoGenerateColumns="False" CssClass="table table-condensed"
                        ...
                        <asp:TemplateField HeaderText="جزییات">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument='<%# Eval("UserRiskID") %>'
                                    CommandName="Detail">مشاهده جزییات</asp:LinkButton>
                                <br />
