    ...
    public partial class SupervisorSetting : System.Web.UI.Page
    {
        ...
        private void GridViewBind()
        {
            using (RiskManagementEntities db = new RiskManagementEntities())
            {
                ...
                var n = from us in db.Users
                        join rl in db.Users
                        on us.fk_CompanyUserID equals rl.UserID into g
        ...
        private void LoadForm()
        {
            ...
            using (RiskManagementEntities db = new RiskManagementEntities())
            {
                ...
                if (n != null)
                {
                    if(n.fk_CompanyUserID!=null)
                    ddlUser.SelectedValue = n.fk_CompanyUserID.ToString();
        ...
        private void InsertForm()
        {
            using (RiskManagementEntities db = new RiskManagementEntities())
            {
                ...
                if(ddlUser.SelectedValue!="-1")
                    us.fk_CompanyUserID = Convert.ToInt32(ddlUser.SelectedValue);
        ...
        private void UpdateForm()
        {
            ...
            using (RiskManagementEntities db = new RiskManagementEntities())
            {
                var n = (from us in db.Users
                         ...
                         select us).FirstOrDefault();
                if (ddlUser.SelectedValue != "-1")
                    n.fk_CompanyUserID = Convert.ToInt32(ddlUser.SelectedValue);
                else
                    n.fk_CompanyUserID = null;
