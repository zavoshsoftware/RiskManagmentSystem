<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true"
    CodeBehind="OperationGroupSetting.aspx.cs" Inherits="RiskManagementSystem.Admin.OperationGroupSetting" %>
    ...
    <div class="minheight">
        <asp:MultiView ID="mvOperationGroup" runat="server" ActiveViewIndex="0">
            <asp:View ID="vwList" runat="server">
                ...
                <br />
                <asp:GridView ID="grdOperationGroup" runat="server" AutoGenerateColumns="False" Width="100%"
            ...
            <asp:View ID="vwEdit" runat="server">
                <div class="fieldGroup">
                    <div class="right2">
                        عنوان پروژه:</div>
                    &nbsp;<div class="left">
                        <asp:TextBox ID="txtOpGroup" runat="server" CssClass="form-control-m"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="  عنوان پروژه را وارد نمایید"
                            ForeColor="Red" ControlToValidate="txtOpGroup" Display="Dynamic">→</asp:RequiredFieldValidator>
                    </div>
                </div>
                <div class="fieldGroup">
                    <div class="right2">
                    ...
                    &nbsp;<div class="left">
                        <asp:TextBox ID="txtOperationGroupName" runat="server" CssClass="form-control-m"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="  عنوان مخفف پروژه را وارد نمایید"
                            ForeColor="Red" ControlToValidate="txtOperationGroupName" Display="Dynamic">→</asp:RequiredFieldValidator>
                    </div>
                </div>
                <div id="butonDiv">
                    &nbsp;<asp:Button ID="Button2" runat="server" Text="ثبت" OnClick="btnSave_Click" CssClass="alert-success"/>
                    &nbsp;<asp:Button ID="Button3" runat="server" CausesValidation="False" Text="انصراف"
                        OnClick="btnCancel_Click" CssClass="alert-danger" />
                </div>
