<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true"
    CodeBehind="SupervisorSetting.aspx.cs" Inherits="RiskManagementSystem.Admin.SupervisorSetting" %>
    ...
    <div class="minheight">
        <asp:MultiView ID="mvUsers" runat="server" ActiveViewIndex="0">
            <asp:View ID="vwList" runat="server">
                <asp:Button ID="btnUsers" runat="server" Text="اضافه کردن ناظر جدید" OnClick="btnUsers_Click"
                    CssClass="btn-info" />
                &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:View ID="vwEdit" runat="server">
                <div class="fieldGroup">
                    <div class="right">
                        پیمانکار:</div>
                    &nbsp;<div class="left">
                        <asp:DropDownList ID="ddlUser" runat="server" CssClass="form-control-xm">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="fieldGroup">
